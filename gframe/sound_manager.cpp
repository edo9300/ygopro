...
#ifdef BACKEND
	for(auto& file : Utils::FindFiles(Utils::ToPathString(working_dir) / fmt::format(EPRO_TEXT("sound/BGM/{}"), path), { EPRO_TEXT("mp3"), EPRO_TEXT("ogg"), EPRO_TEXT("wav"), EPRO_TEXT("flac") })) {
